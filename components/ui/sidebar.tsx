...
const Sidebar = ({
    ...
    const contextValue = useMemo<SidebarContextProps>(
        ...
        [state, open, setOpen, isMobile, isMobileOpen, toggleSidebar, side, variant, collapsible],
    )
                    ...
                    >
                        <div
                            ...
                            className={cn(
                                ...
                                variant === "float" &&
                                "min-h-[calc(100vh-1rem)] rounded-lg border bg-primary/5",
                                className,
                            )}
                        >
                            {children}
...
const SidebarInset = ({ ...props }: ComponentProps<"main">) => {
    return (
        ...
        >
            <main
                className="h-full overflow-auto rounded-lg border border-muted/50 bg-bg"
                {...props}
            />
        </div>
    )
