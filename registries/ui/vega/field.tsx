...
const fieldVariants = tv({
  base: "group/field flex w-full gap-3 has-data-invalid:text-destructive data-[invalid=true]:text-destructive data-invalid:text-destructive hover:not-data-disabled:not-in-data-disabled:**:[[slot=control]]:border-ring!",
  variants: {
    orientation: {
  ...
  const label = (
    <RACLabel
      className={cn(
        ...
        "group/field-label peer/field-label flex w-fit gap-2 leading-snug has-[>[data-slot=field]]:rounded-md has-[>[data-slot=field]]:border has-group-data-selected/field:border-primary/30 has-group-data-selected/field:bg-primary/5 *:data-[slot=field]:p-3 group-data-[disabled=true]/field:opacity-50 dark:has-group-data-selected/field:border-primary/20 dark:has-group-data-selected/field:bg-primary/10",
