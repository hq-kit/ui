...
const DropZone = ({ className, ...props }: DropZoneProps) => (
  <RACDropZone
    className={composeRenderProps(className, (className) =>
      cn(
        "gap-4 rounded-none border-dashed p-6 group flex max-h-50 max-w-xl flex-col items-center justify-center border text-sm outline-hidden transition duration-200 has-[[slot=description]]:text-center",
