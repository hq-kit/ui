...
const AccordionContent = ({ className, children, ...props }: DisclosurePanelProps) => {
  return (
    <DisclosurePanel
      className="text-xs h-(--disclosure-panel-height) overflow-hidden transition-[height] duration-200"
