...
const Example = () => {
  ...
  return (
    <div className='space-y-4'>
      ...
      <Button className='w-full' onClick={handlePaste} size='sm' variant='outline'>
        <IconClipboard className='mr-2 h-4 w-4' />
        Paste Code
      </Button>
      <p className='text-muted-foreground text-xs'>Paste automatically filters to digits only.</p>
    </div>
  )
}
