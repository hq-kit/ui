  ...
  return (
    <RACTreeItem
      className={composeRenderProps(className, (className) =>
        cn(
          [
            "hover:bg-muted data-selected:bg-muted rounded-xl px-2 py-0.75 text-sm font-medium group/tree-item relative flex shrink-0 select-none focus:outline-hidden",
