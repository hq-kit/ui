...
function PopoverTitle({ className, ...props }: ComponentProps<typeof Heading>) {
  return <Heading className={cn("text-sm font-medium", className)} data-slot="popover-title" {...props} />
}

function PopoverDescription({ className, ...props }: ComponentProps<"div">) {
  return <div className={cn("text-muted-foreground text-xs/relaxed", className)} data-slot="popover-description" {...props} />
}
