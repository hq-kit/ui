...
const NavbarHeader = ({ className, ...props }: ComponentProps<"div">) => (
  <div
    className={cn("sticky left-0 z-10 flex items-center gap-2 bg-sidebar p-2", className)}
    data-navbar="header"
...
const NavbarActions = ({ className, ...props }: ComponentProps<"div">) => (
  <div
    className={cn("ml-auto flex items-center gap-2 p-2", className)}
    data-navbar="actions"
...
const NavbarContent = ({ className, ...props }: ComponentProps<"div">) => {
  ...
  return (
    <div
      className={cn(
        "no-scrollbar flex min-h-0 flex-1 gap-0 overflow-auto",
...
const NavbarGroupContent = ({ className, ...props }: ComponentProps<"div">) => (
  <div
    className={cn(
      "flex in-data-[slot=sheet-content]:w-full in-data-[slot=sheet-content]:min-w-0 flex-row in-data-[slot=sheet-content]:flex-col text-xs",
      className
    )}
