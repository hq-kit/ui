...
const SelectSearchableDemo = () => {
  return (
    <Select className='w-full' placeholder='Select a timezone'>
      <Label>Searchable Select</Label>
      <SelectTrigger>
        <SelectValue />
      </SelectTrigger>
      <SelectContent className='max-h-100' isSearchable>
        ...
        <SelectGroup title='Europe & Africa'>
        ...
        <SelectGroup title='Asia'>
          ...
          <SelectItem id='ist_indonesia'>Indonesia Central Standard Time (WITA)</SelectItem>
        </SelectGroup>
        <SelectGroup title='Australia & Pacific'>
          <SelectItem id='awst'>Australian Western Standard Time (AWST)</SelectItem>
          <SelectItem id='acst'>Australian Central Standard Time (ACST)</SelectItem>
          <SelectItem id='aest'>Australian Eastern Standard Time (AEST)</SelectItem>
          <SelectItem id='nzst'>New Zealand Standard Time (NZST)</SelectItem>
          <SelectItem id='fjt'>Fiji Time (FJT)</SelectItem>
        </SelectGroup>
        <SelectGroup title='South America'>
