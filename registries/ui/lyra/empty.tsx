...
function Empty({ className, ...props }: ComponentProps<"div">) {
  return (
    <div
      className={cn(
        "gap-4 rounded-none border-dashed p-6 flex w-full min-w-0 flex-1 flex-col items-center justify-center text-balance text-center",
        className
      )}
      data-slot="empty"
      {...props}
...
function EmptyTitle({ className, ...props }: ComponentProps<"div">) {
  return <div className={cn("text-sm font-medium", className)} data-slot="empty-title" {...props} />
}
...
function EmptyContent({ className, ...props }: ComponentProps<"div">) {
  return (
    <div
      className={cn("gap-2.5 text-xs flex w-full min-w-0 max-w-sm flex-col items-center text-balance", className)}
