...
const scrollFade: RegistryItem = {
  ...
  css: {
    ...
    "@utility scroll-fade": {
      "--_scroll-fade-size-t":
        "var(--scroll-fade-t-size, var(--scroll-fade-size, min(12%, calc(var(--spacing) * 10))))",
      "--_scroll-fade-size-b":
        "var(--scroll-fade-b-size, var(--scroll-fade-size, min(12%, calc(var(--spacing) * 10))))",
      "--scroll-fade-block":
      ...
      "@supports (animation-timeline: scroll())": {
        ...
        "animation-range":
          "0 var(--scroll-fade-reveal, calc(var(--spacing) * 24)), calc(100% - var(--scroll-fade-reveal, calc(var(--spacing) * 24))) 100%",
    ...
    "@utility scroll-fade-x": {
      "--_scroll-fade-size-s":
        "var(--scroll-fade-s-size, var(--scroll-fade-size, min(12%, calc(var(--spacing) * 10))))",
      "--_scroll-fade-size-e":
        "var(--scroll-fade-e-size, var(--scroll-fade-size, min(12%, calc(var(--spacing) * 10))))",
      "--scroll-fade-inline":
    ...
    "@utility scroll-fade-r": {
      "--_scroll-fade-size-e":
        "var(--scroll-fade-e-size, var(--scroll-fade-size, min(12%, calc(var(--spacing) * 10))))",
      "--scroll-fade-mask":
        "linear-gradient(to right, #000 0, #000 calc(100% - var(--scroll-fade-e, 0px)), transparent 100%)",
      "-webkit-mask-image": "var(--scroll-fade-mask)",
      "mask-image": "var(--scroll-fade-mask)",
      "-webkit-mask-composite": "source-in",
      "mask-composite": "intersect",
    ...
    "@utility scroll-fade-*": {
      "--scroll-fade-size": ["calc(var(--spacing) * --value(integer))", "--value([length], [percentage])"]
    },

    "@utility scroll-fade-t-*": {
      "--scroll-fade-t-size": ["calc(var(--spacing) * --value(integer))", "--value([length], [percentage])"]
    },

    "@utility scroll-fade-b-*": {
      "--scroll-fade-b-size": ["calc(var(--spacing) * --value(integer))", "--value([length], [percentage])"]
    },

    "@utility scroll-fade-s-*": {
      "--scroll-fade-s-size": ["calc(var(--spacing) * --value(integer))", "--value([length], [percentage])"]
    },

    "@utility scroll-fade-e-*": {
      "--scroll-fade-e-size": ["calc(var(--spacing) * --value(integer))", "--value([length], [percentage])"]
    },
...
const shimmer: RegistryItem = {
  ...
  css: {
    ...
    "@utility shimmer-spread-*": {
      "--shimmer-spread": ["calc(var(--spacing) * --value(integer))", "--value([length], [percentage])"]
    },
...
export const registryCssUtils = [scrollFade, shimmer]
