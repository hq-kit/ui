...
export default function InputGroupWithKbd() {
  return (
    <FieldGroup>
      <Field>
        <Label htmlFor="input-kbd-22">Input Group with Kbd</Label>
        <InputGroup>
      ...
      <Field>
        <Label htmlFor="input-username-26">Username</Label>
        <InputGroup>
      ...
      <InputGroup data-disabled="true">
        <InputGroupInput disabled id="input-search-disabled-28" placeholder="Search documentation..." />
        <InputGroupAddon>
          <SearchIcon />
        </InputGroupAddon>
      ...
      <FieldGroup className="grid grid-cols-2 gap-4">
        <Field>
          <Label htmlFor="input-group-11">First Name</Label>
          <InputGroup>
        ...
        <Field>
          <Label htmlFor="input-group-12">Last Name</Label>
          <InputGroup>
      ...
      <Field data-disabled="true">
        <Label htmlFor="input-group-29">Loading (&quot;data-disabled=&quot;true&quot;)</Label>
        <InputGroup>
