...
const Label = ({ className, htmlFor, slot, ...props }: LabelProps) => {
  const label = (
    <RACLabel
      className={cn(
        "in-data-disabled:pointer-events-none flex in-data-disabled:cursor-not-allowed select-none items-center gap-2 text-xs leading-none peer-disabled:opacity-50 group-data-[disabled=true]:opacity-50",
        "group/field-label peer/field-label flex w-fit gap-2 leading-snug has-[>[data-slot=field]]:rounded-none has-[>[data-slot=field]]:border has-group-data-selected/field:border-primary/30 has-group-data-selected/field:bg-primary/5 *:data-[slot=field]:p-2 group-data-[disabled=true]/field:opacity-50 dark:has-group-data-selected/field:border-primary/20 dark:has-group-data-selected/field:bg-primary/10",
