  ...
  return (
    <RACCalendar
      ...
      className={composeRenderProps(props.className, (className) =>
        cn(
          "p-3 [--cell-radius:var(--radius-md)] [--cell-size:--spacing(6)] group/calendar grid w-fit place-items-center bg-background in-data-[slot=card-content]:bg-transparent in-data-[slot=popover-content]:bg-transparent",
          className
        )
      )}
      data-slot="calendar"
