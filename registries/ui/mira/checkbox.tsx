      ...
      <CheckboxButton data-slot="checkbox">
        {composeRenderProps(children, (children) => (
          <div className={cn(fieldVariants({ orientation: "horizontal" }))}>
            <span
              className="peer relative flex size-4 shrink-0 items-center justify-center rounded-[4px] border border-input outline-none transition-shadow focus-visible:border-ring focus-visible:ring-2 focus-visible:ring-ring/30 group-disabled/field:cursor-not-allowed group-disabled/field:opacity-50 group-has-disabled/field:opacity-50 aria-invalid:border-destructive aria-invalid:ring-2 aria-invalid:ring-destructive/20 aria-invalid:aria-checked:border-primary group-data-selected/field:border-primary group-data-selected/field:bg-primary group-data-selected/field:text-primary-foreground dark:bg-input/30 dark:group-data-selected/field:bg-primary dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&>svg]:size-3.5"
