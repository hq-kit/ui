...
import { Avatar, Card, Container, Link, Table, buttonStyle } from '@/components/ui'

export default function Dashboard() {
    return (
        <NavbarLayout variant='default'>
            <Container className='flex flex-1 flex-col gap-4 py-6 md:gap-8'>
                                ...
                                <Table.Body>
                                    {transactions.map((transaction) => (
                                        <Table.Row key={transaction.id}>
                                            ...
                                            <Table.Cell className='text-right'>Rp {transaction.amount}</Table.Cell>
                                        </Table.Row>
                                    ))}
                                </Table.Body>
                            </Table>
