  ...
  return (
    <RACTreeItem
      className={composeRenderProps(className, (className) =>
        cn(
          [
            "hover:bg-muted data-selected:bg-muted rounded-none px-1.5 py-[calc(--spacing(0.8))] text-xs font-medium group/tree-item relative flex shrink-0 select-none focus:outline-hidden",
