...
const MessageHeader = ({ className, ...props }: ComponentProps<"div">) => (
  <div
    className={cn("text-xs font-medium text-muted-foreground px-3.5 group-has-data-[variant=ghost]/message:px-0 flex min-w-0 max-w-full items-center", className)}
...
const MessageFooter = ({ className, ...props }: ComponentProps<"div">) => (
  <div
    className={cn(
      "text-xs font-medium text-muted-foreground px-3.5 group-has-data-[variant=ghost]/message:px-0 flex min-w-0 max-w-full items-center group-data-[align=end]/message:justify-end",
      className
    )}
