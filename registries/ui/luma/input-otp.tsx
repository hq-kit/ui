...
function InputOTPGroup({ className, ...props }: ComponentProps<"div">) {
  return (
    <div className={cn("has-aria-invalid:ring-destructive/20 dark:has-aria-invalid:ring-destructive/40 has-aria-invalid:border-destructive rounded-3xl has-aria-invalid:ring-3 flex items-center", className)} data-slot="input-otp-group" {...props} />
  )
}
