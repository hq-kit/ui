...
const ComboBoxSeparator = ({ className, ...props }: SeparatorProps) => (
  <Separator className={cn("bg-border -mx-1.5 my-1.5 h-px", className)} data-slot="select-separator" {...props} />
)
