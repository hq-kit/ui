...
function Navbar({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "bg-sidebar group-data-[variant=floating]:ring-sidebar-border group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:shadow-sm group-data-[variant=floating]:ring-1 fixed inset-x-0 z-30 mx-auto h-(--navbar-height)",
          variant === "floating"
      ...
      >
        ...
        >
          {isMobile && (
            <div className="gap-2 p-2 mr-2 flex items-center">
              <NavbarTrigger />
...
const NavbarHeader = ({ className, ...props }: ComponentProps<"div">) => (
  <div
    className={cn("gap-2 p-2 flex items-center", className)}
    data-navbar="header"
...
const NavbarActions = ({ className, ...props }: ComponentProps<"div">) => (
  <div
    className={cn("gap-2 p-2 ml-auto flex items-center", className)}
    data-navbar="actions"
...
const NavbarContent = ({ className, ...props }: ComponentProps<"div">) => {
  ...
  return (
    <div
      className={cn(
        "no-scrollbar gap-0 flex min-h-0 flex-1 overflow-auto",
...
const NavbarGroupContent = ({ className, ...props }: ComponentProps<"div">) => (
  <div
    className={cn(
      "text-xs flex in-data-[slot=sheet-content]:w-full in-data-[slot=sheet-content]:min-w-0 flex-row in-data-[slot=sheet-content]:flex-col",
      className
    )}
