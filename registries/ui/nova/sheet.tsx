...
function SheetOverlay({
  ...
  return (
    <ModalOverlayPrimitive
      className={cn(
        "bg-black/10 supports-backdrop-filter:backdrop-blur-xs fixed inset-0 z-50 transition-opacity duration-150 data-entering:opacity-0 data-exiting:opacity-0",
        className
      )}
...
function SheetDescription({ className, ...props }: Omit<ComponentProps<"div">, "slot">) {
  return <div className={cn("text-muted-foreground text-sm", className)} data-slot="sheet-description" {...props} />
}
