...
function Navbar({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "bg-sidebar group-data-[variant=floating]:ring-sidebar-border group-data-[variant=floating]:rounded-2xl group-data-[variant=floating]:shadow-sm group-data-[variant=floating]:ring-1 fixed inset-x-0 z-30 mx-auto h-(--navbar-height)",
          variant === "floating"
...
const NavbarHeader = ({ className, ...props }: ComponentProps<"div">) => (
  <div
    className={cn("gap-2 p-2 [--radius:var(--radius-xl)] flex items-center", className)}
    data-navbar="header"
