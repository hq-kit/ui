  ...
  return (
    <RACTreeItem
      className={composeRenderProps(className, (className) =>
        cn(
          [
            "hover:bg-muted data-selected:bg-muted rounded-[calc(var(--radius-md)-2px)] px-2 py-[calc(--spacing(0.85))] text-xs/relaxed font-medium group/tree-item relative flex shrink-0 select-none focus:outline-hidden",
