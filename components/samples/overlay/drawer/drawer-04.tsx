      ...
      <DrawerContent className='lg:h-[calc(100vh-10rem)]'>
        ...
        <div className='space-y-1 overflow-y-auto px-4 text-sm'>
          ...
          <p>
            ...
            services. By accessing or using our services, you agree to comply with these terms. If you do not agree with
            any of these terms, please do not use our services.
          </p>

          <h3>2. Acceptance of Terms</h3>
          <p>
            By using our services, you confirm that you have read, understood, and accepted these terms. You also agree
            to comply with any additional guidelines, policies, or rules that may apply to specific features of our
            services.
          </p>
          ...
          <p>
            All content, including text, images, graphics, and software on our platform, is owned by us or our licensors
            and is protected by copyright laws. You are granted a limited, non-exclusive license to access and use this
            content for personal or business purposes.
          </p>
          ...
          <h3>9. Termination</h3>
          <p>
            We may suspend or terminate your account if you violate these Terms and Conditions or engage in any behavior
            that we deem inappropriate. Upon termination, your access to our services will be revoked, and any
          ...
          <p>
            ...
            on this page, and the revised terms will take effect immediately upon posting. It is your responsibility to
...
export default DrawerWithScrollableContentDemo
