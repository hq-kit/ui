...
const DropZone = ({ className, ...props }: DropZoneProps) => (
  <RACDropZone
    className={composeRenderProps(className, (className) =>
      cn(
        "gap-4 rounded-3xl border-dashed p-12 group flex max-h-50 max-w-xl flex-col items-center justify-center border text-sm outline-hidden transition duration-200 has-[[slot=description]]:text-center",
