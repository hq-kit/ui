...
<Demo center component='overlays/modal/alert-dialog-demo' />
Notice how the modal is dismissable and the close button is hidden? That's 'cause the role is set to
`alertdialog`.
...
<Demo center component='overlays/modal/modal-blur-demo' />
...
<Demo center component='overlays/modal/modal-custom-style-demo' />

## Class Names

To add custom class names to your content or overlay, refer to this demonstration:

<Demo center component='overlays/modal/modal-custom-classnames-demo' />
