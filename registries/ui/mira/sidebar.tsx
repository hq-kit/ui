...
function SidebarInput({ className, ...props }: ComponentProps<typeof Input>) {
  return (
    <Input className={cn("bg-muted/20 dark:bg-muted/30 border-input h-8 w-full", className)} data-sidebar="input" data-slot="sidebar-input" {...props} />
  )
}
