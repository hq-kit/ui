...
const ChartTooltipContent = ({
  ...
  return (
    <div className={cn("bg-popover text-popover-foreground ring-foreground/10 gap-1.5 px-2.5 py-1.5 text-xs shadow-sm ring-1 grid min-w-32 items-start", className)}>
