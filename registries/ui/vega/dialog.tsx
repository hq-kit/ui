...
const DialogTitle = ({ className, ...props }: RACHeadingProps) => (
  <Heading className={cn("leading-none font-medium", className)} data-slot="title" {...props} />
)
