...
export const Presets: Record<string, ThemeStyle> = {
    ...
    bootstrap: {
        light: {
            ...
            '--muted': 'hsl(210 15.79% 92.55%)',
            '--muted-fg': 'hsl(208.24 7.3% 45.69%)'
        },
        dark: {
            '--bg': 'hsl(210 10.81% 14.51%)',
            '--fg': 'hsl(0 0% 100%)',
