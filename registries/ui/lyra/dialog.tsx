...
const DialogHeader = ({ className, ...props }: ComponentPropsWithRef<"div">) => (
  <div className={cn("gap-1 text-left flex flex-col", className)} data-slot="header" {...props} />
)
