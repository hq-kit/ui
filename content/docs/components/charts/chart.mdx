...
<Step title='Start by defining your data'>
...
<Step title='Define your chart config</Step>'>
...
<Note className="mt-4 bg-amber-50 border-amber-200 dark:bg-amber-950/50 dark:border-amber-950">

**Important:** Remember to set a `min-h-[VALUE]` on the `ChartContainer` component. This is required for the chart to be responsive.

</Note>

<Demo component='chart/docs/chart-example' />
</Step>
</Steps>
...
<Step title='Import the `CartesianGrid` component.'>

```tsx /CartesianGrid/
import { Bar, BarChart, CartesianGrid } from "recharts"
```
</Step>
<Step title='Add the `CartesianGrid` component to your chart.'>
...
<Demo component='chart/docs/chart-example-grid' />
</Step>
</Steps>
...
<Step title='Import the `XAxis` component.'>
...
<Demo component='chart/docs/chart-example-axis' />
</Step>
</Steps>
...
<Step title='Import the `ChartTooltip` and `ChartTooltipContent` components.'>
...
<Step title='Add the components to your chart.'>
...
<Demo component='chart/docs/chart-example-tooltip' />
...
<Step title='Import the `ChartLegend` and `ChartLegendContent` components.'>
...
<Demo component='chart/docs/chart-example-legend' />
...
<Step title='Define your colors in your css file'>
...
<Step title='Add the color to your `chartConfig`'>
...
<Demo component='chart/docs/chart-tooltip' />
