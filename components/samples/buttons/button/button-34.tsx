    ...
    <Button
      ...
      className={cn(
        isDark
          ...
          : 'border-amber-600 text-amber-600! hover:bg-amber-600/10 focus-visible:border-amber-600 focus-visible:ring-amber-600/20 dark:border-amber-400 dark:text-amber-400! dark:focus-visible:border-amber-400 dark:focus-visible:ring-amber-400/40 dark:hover:bg-amber-400/10'
      )}
