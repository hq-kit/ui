...
const contextMenuItemVariants = tv({
  ...
  variants: {
    selectionMode: {
      ...
      single:
        "gap-2.5 rounded-none py-2 pr-8 pl-3 font-medium text-xs uppercase tracking-wider focus:bg-accent focus:text-accent-foreground data-inset:pl-9.5 [&_svg:not([class*='size-'])]:size-3.5",
      multiple:
        "gap-2.5 rounded-none py-2 pr-8 pl-3 font-medium text-xs uppercase tracking-wider focus:bg-accent focus:text-accent-foreground data-inset:pl-9.5 [&_svg:not([class*='size-'])]:size-3.5"
    }
  }
