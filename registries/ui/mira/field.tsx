...
const Legend = ({
  ...
  <legend className={cn("mb-2 font-medium data-[variant=label]:text-xs/relaxed data-[variant=legend]:text-sm", className)} data-slot="field-legend" data-variant={variant} {...props} />
)
...
const Title = ({ className, ...props }: LabelProps) => (
  <RACLabel className={cn("gap-2 text-xs/relaxed font-medium group-data-[disabled=true]/field:opacity-50 flex w-fit items-center", className)} data-slot="field-label" {...props} />
)
...
const FieldError = (props: FieldErrorProps) => {
  return (
    <RACFieldError
      className={composeRenderProps(props.className, (className) => cn("text-destructive text-xs/relaxed font-normal", className))}
