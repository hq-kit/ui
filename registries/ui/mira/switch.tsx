      ...
      <SwitchButton data-slot="switch">
        {composeRenderProps(children, (children) => (
          <div className={cn(fieldVariants({ orientation: "horizontal" }))}>
            <div
              className={cn(
                "peer group/switch relative inline-flex shrink-0 items-center rounded-full border border-transparent not-group-data-selected/field:bg-input outline-none transition-all after:absolute focus-visible:border-ring focus-visible:ring-2 focus-visible:ring-ring/30 aria-invalid:border-destructive aria-invalid:ring-2 aria-invalid:ring-destructive/20 data-[size=default]:h-[16.6px] data-[size=sm]:h-[14px] data-[size=default]:w-[28px] data-[size=sm]:w-[24px] group-data-disabled/field:cursor-not-allowed group-data-selected/field:bg-primary group-data-disabled/field:opacity-50 dark:not-group-data-selected/field:bg-input/80 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40",
                className
              )}
              data-size={size}
              data-slot="switch"
