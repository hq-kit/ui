  ...
  return (
    <div className='relative flex w-full items-start gap-2 rounded-md border border-input p-4 shadow-xs outline-none has-data-[selected=true]:border-primary/50'>
      <Switch
        ...
        className='order-1 h-4 w-6 after:absolute after:inset-0 [&_span]:size-3 data-[selected=true]:[&_span]:translate-x-2.5 data-[selected=true]:[&_span]:rtl:-translate-x-2.5'
        id={id}
      />
