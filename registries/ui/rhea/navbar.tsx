...
const Navbar = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "fixed inset-x-0 z-30 mx-auto h-(--navbar-height) bg-sidebar transition-all group-data-[variant=floating]:rounded-2xl group-data-[variant=floating]:shadow-sm group-data-[variant=floating]:ring-1 group-data-[variant=floating]:ring-sidebar-border",
