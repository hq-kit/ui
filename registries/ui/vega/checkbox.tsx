      ...
      <CheckboxButton data-slot="checkbox">
        {composeRenderProps(children, (children) => (
          <div className={cn(fieldVariants({ orientation: "horizontal" }))}>
            <span
              className="border-input size-4 [&>svg]:size-3.5 dark:bg-input/30 dark:group-data-selected/field:bg-primary group-data-selected/field:bg-primary group-data-selected/field:text-primary-foreground group-data-selected/field:border-primary group-data-indeterminate/field:bg-primary group-data-indeterminate/field:text-primary-foreground dark:group-data-indeterminate/field:bg-primary group-data-indeterminate/field:border-primary group-data-invalid/field:group-data-selected/field:border-primary group-data-invalid/field:border-destructive dark:group-data-invalid/field:border-destructive/50 focus-visible:border-ring focus-visible:ring-ring/50 group-data-invalid/field:ring-destructive/20 dark:group-data-invalid/field:ring-destructive/40 flex items-center justify-center rounded-[4px] border shadow-xs transition-colors group-has-disabled/field:opacity-50 focus-visible:ring-3 group-data-invalid/field:ring-3 peer relative shrink-0 outline-none group-disabled/field:cursor-not-allowed group-disabled/field:opacity-50"
