...
const PopoverTitle = ({ className, ...props }: ComponentProps<typeof Heading>) => (
  <Heading className={cn("font-medium text-sm", className)} data-slot="popover-title" {...props} />
)

const PopoverDescription = ({ className, ...props }: ComponentProps<"div">) => (
  <div className={cn("text-muted-foreground text-xs/relaxed", className)} data-slot="popover-description" {...props} />
)
