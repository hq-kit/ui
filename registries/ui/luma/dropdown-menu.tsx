...
const dropdownMenuItemVariants = tv({
  ...
  variants: {
    selectionMode: {
      ...
      single:
        "gap-2.5 rounded-2xl py-2 pr-8 pl-3 font-medium text-sm focus:bg-accent focus:text-accent-foreground focus:**:text-accent-foreground data-inset:pl-9.5 [&_svg:not([class*='size-'])]:size-4",
      multiple:
        "gap-2.5 rounded-2xl py-2 pr-8 pl-3 font-medium text-sm focus:bg-accent focus:text-accent-foreground focus:**:text-accent-foreground data-inset:pl-9.5 [&_svg:not([class*='size-'])]:size-4"
    }
  }
