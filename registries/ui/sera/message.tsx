...
const MessageHeader = ({ className, ...props }: ComponentProps<"div">) => (
  <div
    className={cn(
      "flex min-w-0 max-w-full items-center px-4 font-medium text-muted-foreground text-xs uppercase tracking-wide group-has-data-[variant=ghost]/message:px-0",
      className
    )}
...
const MessageFooter = ({ className, ...props }: ComponentProps<"div">) => (
  <div
    className={cn(
      "flex min-w-0 max-w-full items-center px-4 font-medium text-muted-foreground text-xs uppercase tracking-wide group-has-data-[variant=ghost]/message:px-0 group-data-[align=end]/message:justify-end",
      className
    )}
