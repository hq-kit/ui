...
const ContextMenuSeparator = ({ className, ...props }: ComponentProps<typeof Separator>) => (
  <Separator className={cn("-mx-1 my-1 h-px bg-border/50", className)} data-slot="context-menu-separator" {...props} />
)
