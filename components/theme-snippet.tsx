      ...
      <Modal.Content size='2xl'>
        ...
        <Modal.Footer className='justify-start sm:flex-col'>
          ...
          <Modal.Description>
            ...
            <Link className='p-0 font-semibold text-primary' href={currentFontSansFamily.link} target='_blank'>
              {currentFontSansFamily.label}
            </Link>
            , and Font Mono is:{' '}
            <Link className='p-0 font-semibold text-primary' href={currentFontMonoFamily.link} target='_blank'>
...
const CopyCode = () => {
  ...
  return <Code code={generateThemeCode(theme)} filename='app.css' lang='css' withoutSwitcher />
}
