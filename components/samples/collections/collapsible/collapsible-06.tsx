  ...
  return (
    <div className='w-full space-y-4'>
      <div className='space-y-2'>
        ...
        <Collapsible className='space-y-2' isExpanded={isTrackOrderOpen} onExpandedChange={setIsTrackOrderOpen}>
          <CollapsibleContent>
            <p className='text-sm'>
      ...
      <div className='space-y-2'>
        ...
        <Collapsible className='space-y-2' isExpanded={isCancelOrderOpen} onExpandedChange={setIsCancelOrderOpen}>
          <CollapsibleContent>
            <p className='text-sm'>
