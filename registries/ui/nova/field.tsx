...
const Legend = ({
  ...
  <legend className={cn("mb-1.5 font-medium data-[variant=label]:text-sm data-[variant=legend]:text-base", className)} data-slot="field-legend" data-variant={variant} {...props} />
)
...
const Label = (props: LabelProps) => (
  <RACLabel
    className={cn(
      "gap-2 text-sm leading-none font-medium in-data-disabled:opacity-50 in-data-disabled:pointer-events-none flex in-data-disabled:cursor-not-allowed select-none items-center",
      "has-data-selected:bg-primary/5 has-data-selected:border-primary/30 dark:has-data-selected:border-primary/20 dark:has-data-selected:bg-primary/10 gap-2 leading-snug in-data-disabled:opacity-50 has-[>[data-slot=field]]:rounded-lg has-[>[data-slot=field]]:border *:data-[slot=field]:p-2.5 group/field-label peer/field-label flex w-fit",
