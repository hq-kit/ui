...
const ThemeColorPanel = () => {
    ...
    return (
        <div className='space-y-6'>
            <Accordion defaultExpandedKeys={['brand']} allowsMultipleExpanded className='w-full space-y-4'>
                {/* Brand Colors */}
                <AccordionItem id='brand' className='rounded-lg border px-4'>
                ...
                {/* Base Colors */}
                <AccordionItem id='base' className='rounded-lg border px-4'>
                ...
                {/* Other Colors */}
                <AccordionItem id='other' className='rounded-lg border px-4'>
                ...
                {/* Sidebar Colors */}
                <AccordionItem id='sidebar' className='rounded-lg border! px-4'>
                ...
                {/* Chart Colors */}
                <AccordionItem id='chart' className='rounded-lg border! px-4'>
