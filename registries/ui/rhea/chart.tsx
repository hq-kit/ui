...
const ChartTooltipContent = ({
  ...
  return (
    <div className={cn("bg-popover text-popover-foreground ring-foreground/5 dark:ring-foreground/10 gap-1.5 rounded-xl px-2.5 py-1.5 text-xs shadow-lg ring-1 grid min-w-32 items-start", className)}>
...
const Chart = (props: ComponentProps<typeof ChartContainer>) => <ChartContainer {...props} />
