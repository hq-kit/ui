  ...
  <ToolbarContext.Provider value={{ orientation }}>
    <RACToolbar
      ...
      className={composeRenderProps(className, (className) =>
        cn(
          "group/toolbar flex gap-[--spacing(var(--gap))] data-[spacing=0]:data-[variant=outline]:rounded-none data-[orientation=vertical]:flex-col data-[orientation=vertical]:items-stretch",
          className
        )
      )}
    />
