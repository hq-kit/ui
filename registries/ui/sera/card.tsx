...
function CardTitle({ className, ...props }: ComponentProps<"div">) {
  return <div className={cn("text-lg font-semibold tracking-wider uppercase", className)} data-slot="card-title" {...props} />
}
...
function CardFooter({ className, ...props }: ComponentProps<"div">) {
  return <div className={cn("px-(--card-spacing) [.border-t]:pt-(--card-spacing) flex items-center", className)} data-slot="card-footer" {...props} />
}
