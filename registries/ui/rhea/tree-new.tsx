  ...
  return (
    <RACTreeItem
      className={composeRenderProps(className, (className) =>
        cn(
          [
            "hover:bg-muted data-selected:bg-muted rounded-2xl px-1.5 py-0.5 text-sm font-medium group/tree-item relative flex shrink-0 select-none focus:outline-hidden",
