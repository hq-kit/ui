...
function DialogHeader({ className, ...props }: ComponentProps<"div">) {
  return <div className={cn("gap-1.5 flex flex-col", className)} data-slot="dialog-header" {...props} />
}
